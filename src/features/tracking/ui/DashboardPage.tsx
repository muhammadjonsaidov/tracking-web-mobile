...
import { useNetworkInfo } from '@/shared/hooks/useNetworkInfo';
import { useNowTicker } from '@/shared/hooks/useNowTicker';
import { approxDistanceM, formatCoords, simplifyRdp, smoothPath } from '@/shared/utils/geo';
import { nowIsoUtc, uuid } from '@/shared/utils/id';
...
export function DashboardPage() {
    ...
    async function startTracking() {
        ...
        try {
            ...
            const data = await unwrap<StartSessionResponse>(api.post('/api/v1/tracking/sessions/start'));
